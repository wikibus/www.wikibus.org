  ...
  SEMICOLON.initialize = {
    ...
    lightbox() {
      ...
      $('[data-lightbox]').on('mfpOpen', () => {
        const lightboxItem	= $.magnificPopup.instance.currItem.el
        const lightboxClass	= $(lightboxItem).attr('data-lightbox-class')
        const lightboxBgClass	= $(lightboxItem).attr('data-lightbox-bg-class')
