(function () {
  const tabfocus = (function () {
    ...
    const global$6 = tinymce.util.Tools.resolve('tinymce.util.VK')
    ...
    const setup = function (editor) {
      function tabHandler(e) {
        ...
        if (el) {
          const focusEditor = global$2.get(el.id || el.name)
